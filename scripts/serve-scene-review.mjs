...
createServer(async(req,res)=>{
  if(/^\/models\/blender\/library-furnishings\/(ShelfBoard|ShelfUpright|Return|BBQ)\.glb$/.test(req.url)){res.setHeader('Content-Type','model/gltf-binary');res.end(await readFile(req.url.slice(1)));}
