...
createServer(async(req,res)=>{
  if(req.url==='/models/blender/bathroom/bathroom.glb'){res.setHeader('Content-Type','model/gltf-binary');res.end(await readFile('models/blender/bathroom/bathroom.glb'));}
