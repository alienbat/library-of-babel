...
- Probes are moved out of solid geometry before baking to reduce black interpolation
...
and falls back to CPU otherwise. `BAKE_SAMPLES` defaults to 1024. The exported scene
