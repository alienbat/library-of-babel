...
export function createBathroomFixtures(
  ...
  coarse('#c6cbc1', [
    [-2, 0.25, 1.75, 0.32, 0.5, 0.5],
    [-2, 0.5, 1.675, 0.51, 0.1, 0.67],
    [-2, 0.65, 2.028, 0.43, 0.44, 0.23],
    [-0.4, 0.79, -1.73, 1.1, 0.17, 0.58],
    [2, 0.03, -1.25, 1.65, 0.06, 1.75],
    [2, 0.03, 1.25, 1.65, 0.06, 1.75],
    [-1.39, 0.95, 1.8, 0.17, 0.23, 0.29],
  ]);
  coarse('#a6b0a6', [
