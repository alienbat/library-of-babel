...
export function bookId(b:BookLocation){
  ...
  return `v2/${b.frame.destination}/F${BigInt(b.frame.floorOffset)+BigInt(b.level)}/S${BigInt(b.frame.sectionOffset)+BigInt(b.bay)}/${b.side===1?'N':'S'}/R${b.row+1}/B${b.book+1}`;
}
